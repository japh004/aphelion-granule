...
const testimonials = [
    {
        id: 1,
        quote: "Grâce à DRISSMAN, j'ai trouvé une auto-école près de chez moi à Bastos en 5 minutes. Le moniteur était patient et j'ai eu mon permis du premier coup !",
        name: "Amina N.",
        role: "Étudiante, Yaoundé",
        rating: 5,
        image: "/assets/testimonial-amina.png",
        offsetY: 125
    },
    {
        id: 2,
        quote: "La réservation en ligne est ultra simple. Plus besoin d'appeler 10 auto-écoles pour comparer les prix. Tout est transparent et je peux payer via Orange Money.",
        name: "Kevin T.",
        role: "Développeur, Douala",
        rating: 5,
        image: "/assets/testimonial-kevin.png",
        offsetY: 110
    },
    {
        id: 3,
        quote: "J'avais peur de reprendre le volant après des années. Mon moniteur à Akwa a été patient et j'ai retrouvé confiance. Merci DRISSMAN !",
        name: "Grace M.",
        role: "Entrepreneuse, Douala",
        rating: 5,
        image: "/assets/testimonial-grace.png",
        offsetY: 125
    }
];
